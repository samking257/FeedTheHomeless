package com.example.feedthehomeless.CouncilUI.settings;
...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.council_settings, container, false);
    ...
    private void initialiseComponents(View root) {
        ...
        btnLogout = root.findViewById(R.id.btnCouncilLoginOut);
